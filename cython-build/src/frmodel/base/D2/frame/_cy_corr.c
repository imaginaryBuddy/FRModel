 ...
 *             unsigned int radius,
 */
  __pyx_tuple__22 = PyTuple_Pack(28, __pyx_n_s_a, __pyx_n_s_b, __pyx_n_s_radius, __pyx_n_s_verbose, __pyx_n_s_a_view, __pyx_n_s_b_view, __pyx_n_s_w_size, __pyx_n_s_wi_rows, __pyx_n_s_wi_cols, __pyx_n_s_wi_r, __pyx_n_s_wi_c, __pyx_n_s_w_rows, __pyx_n_s_w_cols, __pyx_n_s_w_r, __pyx_n_s_w_c, __pyx_n_s_w_channels, __pyx_n_s_w_ch, __pyx_n_s_out_v, __pyx_n_s_out_v_view, __pyx_n_s_mean_a, __pyx_n_s_mean_b, __pyx_n_s_mean_a2, __pyx_n_s_mean_b2, __pyx_n_s_del_a, __pyx_n_s_del_b, __pyx_n_s_del_ab, __pyx_n_s_std_a, __pyx_n_s_std_b); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(4, 0, 28, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_src_frmodel_base_D2_frame__cy_co, __pyx_n_s_cy_corr, 12, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 12, __pyx_L1_error)
